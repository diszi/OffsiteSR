...
public class UpdatePrioritySOAP<T extends String> extends AbstractSOAP<T>{
    ...
    public UpdatePrioritySOAP(String ticketId,String priority){
    ...
    protected String getSOAPPayload() {
        ...
        //System.out.println("---------> UpdatePrioritySOAP > priority = "+priority);
        ...
        return "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:max=\"http://www.ibm.com/maximo\">\n" +
                ...
                " \n" +
                "\n" +
                "  <max:INTERNALPRIORITY maxvalue=\""+priority+"\" changed=\"True\" >"+priority+"</max:INTERNALPRIORITY>\n" +
                "\n" +
